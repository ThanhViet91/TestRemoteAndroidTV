 ...
 * @since 06.02.18
 */
public class TaskJS extends AsyncTask<Integer, Void, List<TaskJS.Result>> {
    ...
    TaskJS(Context context, RhinoAndroidHelper rhinoAndroidHelper) {
        this.rhinoAndroidHelper = rhinoAndroidHelper;
        this.context = new WeakReference<>(context);
        this.progressDialog = new ProgressDialog(context);
        StringBuilder builder = new StringBuilder();
        try {
            InputStream codeStream = context.getResources().openRawResource(R.raw.pi);
    ...
    protected List<Result> doInBackground(Integer... params) {
        ...
        for (int i : params) {
            ...
            for (int j = 0; j < 10; j++) {
                context.compileString(code, "pi", 1, null);
            }
        }
        ...
        for (int i : params) {
            ...
            Script script = context.compileString(code, "pi", 1, null);
